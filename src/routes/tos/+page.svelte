	...
	<div align="center" style="text-align: left;">
		<div class="MsoNormal" data-custom-class="title" style="line-height: 1.5;">
			<bdt class="block-component"><span style="font-size: 19px;"></span></bdt><bdt class="question"
				><strong><h1>TERMS OF SERVICE</h1></strong></bdt
			><bdt class="statement-end-if-in-editor"></bdt>
		</div>
		<div class="MsoNormal" data-custom-class="subtitle" style="line-height: 1.5;">
			<strong>Last updated</strong> <bdt class="question"><strong>November 12, 2025</strong></bdt>
		</div>
		<div class="MsoNormal" style="line-height: 1.1;"><br /></div>
		<div style="line-height: 1.5;"><br /></div>
		<div style="line-height: 1.5;">
			<strong
				><span data-custom-class="heading_1"><h2>AGREEMENT TO OUR LEGAL TERMS</h2></span></strong
			>
		</div>
	</div>
	<div align="center" style="text-align: left;">
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				>We are <bdt
					...
					data-type="question noTranslate">WIT-Calendar</bdt
...
mso-themetint:166;"><bdt class="block-component"></bdt></span
							>, a club at WIT in<bdt class="block-component"></bdt><bdt
...
Arial;mso-fareast-font-family:Calibri;color:#595959;mso-themecolor:text1;
mso-themetint:166;"
									><bdt class="question noTranslate">Massachusetts</bdt>,
									<bdt class="question noTranslate">United States</bdt></span
								></span
			...
			<bdt class="question noTranslate"></bdt><span style="font-size: 15px;"
				><span data-custom-class="body_text"
					><span style="font-size: 15px;"
						><span data-custom-class="body_text"
							><span style="color: rgb(89, 89, 89);"
								><bdt class="block-component"></bdt><bdt class="block-component"></bdt>
								<bdt class="question noTranslate"></bdt><bdt class="statement-end-if-in-editor"
								></bdt><bdt class="block-component"></bdt><bdt class="block-component"></bdt></span
							></span
						></span
					></span
				></span
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				...
				<span style="color: rgb(0, 58, 250);"
					><bdt class="question noTranslate"
						><a target="_blank" data-custom-class="link" href="https://calendar.witcc.dev"
				...
				></bdt>)<bdt class="block-component"></bdt><bdt class="block-component"></bdt>, as well as
		...
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
			<bdt class="question"
				>WIT-Calendar is a Chrome extension that makes adding your classes to your calendar easy
				&amp; quick!</bdt
			>
		</div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				>You can contact us by <bdt class="block-component"
					...
					<bdt class="question noTranslate"></bdt><bdt class="block-component"></bdt><bdt
						class="block-component"
					></bdt> <bdt class="question noTranslate"></bdt><bdt class="statement-end-if-in-editor"
					></bdt><bdt class="block-component"></bdt><bdt class="block-component"></bdt><bdt
						class="block-component"
					></bdt><bdt class="block-component"></bdt><bdt class="question noTranslate"
						></bdt
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				...
				<bdt class="question noTranslate">WIT-Calendar</bdt>, concerning your access to and use of
				the Services. You agree that by accessing the Services, you have read, understood, and
				...
				USE IMMEDIATELY.<bdt class="block-component"></bdt><bdt class="block-component"></bdt></span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1;"><br /></div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
			<span
				style="font-size:11.0pt;line-height:115%;font-family:Arial;
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				><bdt class="question">There will be an update in-extension, letting users know.</bdt><bdt
					class="statement-end-if-in-editor"
				...
				><bdt data-type="conditional-block"
					><bdt data-type="body"
						><span
							style="font-size:11.0pt;line-height:115%;font-family:Arial;
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
							><bdt class="block-component"></bdt>The Services are intended for users who are at
							least 18 years old. Persons under the age of 18 are not permitted to use or register
							for the Services.</span
						></bdt
					></bdt
				><bdt data-type="conditional-block"><bdt class="block-component"></bdt></bdt></bdt
			>
		</div>
		<div class="MsoNormal" style="line-height: 1;"><br /></div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#userreps"></a><a data-custom-class="link" href="#userreps"
				><span style="color: rbg(0, 58, 250); font-size: 15px; line-height: 1.5;"
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#prohibited"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">5. PROHIBITED ACTIVITIES</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#ugc"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">6. USER GENERATED CONTRIBUTIONS</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#sitemanage"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">9. SERVICES MANAGEMENT</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#terms"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">11. TERM AND TERMINATION</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#modifications"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">12. MODIFICATIONS AND INTERRUPTIONS</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#law"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">13. GOVERNING LAW</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#disputes"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">14. DISPUTE RESOLUTION</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#corrections"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">15. CORRECTIONS</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#disclaimer"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">16. DISCLAIMER</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#liability"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">17. LIMITATIONS OF LIABILITY</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#indemnification"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">18. INDEMNIFICATION</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#userdata"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">19. USER DATA</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#electronic"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text"
						>20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</span
					></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#misc"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">22. MISCELLANEOUS</span></span
				></a
		...
		<div class="MsoNormal" style="line-height: 1.5;">
			<a data-custom-class="link" href="#contact"
				><span style="color: rgb(0, 58, 250); font-size: 15px;"
					><span data-custom-class="body_text">23. CONTACT US</span></span
				></a
			>
		</div>
	</div>
	<div align="center" style="text-align: left;">
		...
		<div class="MsoNormal" data-custom-class="heading_1" id="services" style="line-height: 1.5;">
			<strong
				><span style="font-size: 19px; line-height: 1.5;"><h2>1. OUR SERVICES</h2></span></strong
			>
		</div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
			<span style="font-size: 15px;"
		...
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
			<span style="font-size: 15px;"
				...
				Gramm-Leach-Bliley Act (GLBA).<bdt class="block-component"></bdt><bdt
					class="statement-end-if-in-editor"
				></bdt></span
			>
		</div>
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				...
				intellectual property rights and unfair competition laws) and treaties<bdt
					class="block-component"
				></bdt>
				in the United States and<bdt class="statement-end-if-in-editor"></bdt> around the world.</span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5;"><br /></div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
		...
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
			<span
				style="font-size:11.0pt;line-height:115%;font-family:Arial;
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				>solely for your <bdt class="block-component"></bdt>personal, non-commercial use or internal
				business purpose<bdt class="statement-end-if-in-editor"></bdt>.</span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5;"><br /></div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				><strong></strong>
				<h3><strong>Your submissions<bdt class="block-component"></bdt></strong></h3></span
			>
		</div>
		<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
			<span style="font-size: 15px;"
		...
		<ul>
			...
			<li class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
				<span style="font-size: 15px;"
					...
					or that you have the necessary rights and <bdt class="block-component"></bdt>licenses<bdt
						class="statement-end-if-in-editor"
					></bdt>
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
	...
	<div align="center" style="text-align: left;">
		<div class="MsoNormal" style="text-align: justify; line-height: 115%;">
			...
			<div class="MsoNormal" style="text-align: justify; line-height: 1.5;">
				...
				>
					<strong
						><span style="line-height: 1.5; font-size: 19px;"
							><h2>5. PROHIBITED ACTIVITIES</h2></span
						></strong
					>
				</div>
			</div>
										...
										><span
											...
											><span style="line-height: 16.8667px; color: rgb(89, 89, 89);"
												><span
													...
													to learn sensitive account information such as user passwords.</span
												></span
											></span
										></span
									></span
										...
										><span
											...
											><span style="line-height: 16.8667px; color: rgb(89, 89, 89);"
												><span
													...
													functions, operation, or maintenance of the Services.</span
												></span
											></span
										></span
									></span
										...
										><span
											...
											><span style="line-height: 16.8667px; color: rgb(89, 89, 89);"
												><span
													...
													(sometimes referred to as <bdt class="block-component"></bdt>"spyware" or
											...
											><span style="line-height: 16.8667px; color: rgb(89, 89, 89);"
												><span
													...
													reader that accesses the Services, or use or launch any <bdt
														class="block-component"
													></bdt>unauthorized<bdt class="statement-end-if-in-editor"></bdt> script or
													other software.</span
												></span
											></span
										></span
							...
							><bdt data-type="conditional-block"
								><bdt data-type="body"
									...
									>
										<strong
											><span style="line-height: 1.5; font-size: 19px;"
												><h2>6. USER GENERATED CONTRIBUTIONS</h2></span
											></strong
										>
									</div></bdt
								></bdt
											...
											><bdt
												...
												><bdt data-type="conditional-block"
													...
													></bdt><span
														...
														and through third-party websites.<bdt class="block-component"></bdt> As
														such, any Contributions you transmit may be treated in accordance with
														the Services' Privacy Policy.<bdt class="statement-end-if-in-editor"
														></bdt>
							...
							<span style="color: rgb(89, 89, 89);"
								><span style="font-size: 14px;"
									><span data-custom-class="body_text"
										...
										harassing, <bdt class="block-component"></bdt>libelous<bdt
											class="statement-end-if-in-editor"
										></bdt>, slanderous, or otherwise objectionable (as determined by us).</span
									></span
								></span
							>
						</li>
							...
							><bdt data-type="body"
								><div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
									<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
										...
										rights to use the Services.</span
									>
								</div></bdt
							></bdt
						></bdt
			...
			>
				<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
					><span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
						...
						personal data that you provide<bdt class="block-component"></bdt> following the terms of
						the Privacy Policy<bdt class="statement-end-if-in-editor"></bdt> and your choices (including
						settings).</span
					></span
				>
			</div>
			...
			<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
				<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
					...
					use and share such feedback for any purpose without compensation to you.<bdt
						class="block-component"
					></bdt></span
				>
			</div>
			...
			<div class="MsoNormal" data-custom-class="body_text" style="line-height: 1.5;">
				<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
					...
					us regarding your Contributions.<bdt class="statement-end-if-in-editor"></bdt></span
				>
			</div>
		...
		<div class="MsoNormal" data-custom-class="heading_1" id="sitemanage" style="line-height: 1.5;">
			<strong
				><span style="line-height: 1.5; font-size: 19px;"><h2>9. SERVICES MANAGEMENT</h2></span
				></strong
			>
		</div>
		<div
		...
		<div class="MsoNormal" data-custom-class="heading_1" id="ppyes" style="line-height: 1.5;">
			<strong><h2>10. PRIVACY POLICY</h2></strong>
		</div>
		<div
			class="MsoNormal"
			data-custom-class="body_text"
		...
		>
			<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
				>We care about data privacy and security. Please review our Privacy Policy:<strong
					>&nbsp;<span style="color: rgb(0, 58, 250);"
						><bdt
							...
							data-type="question noTranslate"
							><a target="_blank" data-custom-class="link" href="https://calendar.witcc.dev/privacy"
								>https://calendar.witcc.dev/privacy</a
							></bdt
						></span
					></strong
				...
				<bdt class="question noTranslate">United States</bdt><bdt class="block-component"></bdt><bdt
					class="block-component"
				></bdt>. If you access the Services from any other region of the world with laws or other
				requirements governing personal data collection, use, or disclosure that differ from
				applicable laws in
				<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
					><bdt class="block-component"></bdt>the
					<bdt class="question noTranslate">United States</bdt><bdt class="block-component"
					></bdt></span
		...
		>
			<strong
				><span style="line-height: 1.5; font-size: 19px;"><h2>11. TERM AND TERMINATION</h2></span
				></strong
			>
		</div>
		<div
		...
		>
			<strong
				><span style="line-height: 1.5; font-size: 19px;"
					><h2>12. MODIFICATIONS AND INTERRUPTIONS</h2></span
				></strong
			>
		</div>
		<div
		...
		>
			<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
				...
				update any information on our Services.<bdt class="block-component"></bdt> We will not be liable
		...
		>
			<strong
				><span style="line-height: 1.5; font-size: 19px;"><h2>13. GOVERNING LAW</h2></span></strong
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;">
			<span style="font-size: 11pt; line-height: 16.8667px; color: rgb(89, 89, 89);"
				...
				with the laws of <bdt
					...
					><bdt data-type="conditional-block"
						...
						></bdt><bdt data-type="body"
							>the Commonwealth of <bdt class="question noTranslate">Massachusetts</bdt><bdt
								class="block-component"
							></bdt></bdt
						>
									...
									><bdt
										...
										><bdt data-type="conditional-block"
											><bdt
												...
												data-type="statement"
											></bdt><bdt data-type="body"
												>the Commonwealth of <bdt class="question noTranslate">Massachusetts</bdt
												><bdt class="block-component"></bdt></bdt
											><span style="font-size: 14.6667px;">,&nbsp;</span>without regard to its
											conflict of law principles.<bdt class="block-component"></bdt></bdt
										></bdt
									></span
								></bdt
							></bdt
		...
		>
			<strong
				><span style="line-height: 1.5; font-size: 19px;"><h2>14. DISPUTE RESOLUTION</h2></span
				></strong
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;">
		...
		>
			<bdt class="block-component"><span style="font-size: 15px;"></span></bdt><span
				...
				SUE IN COURT AND HAVE A JURY TRIAL. <bdt class="block-component"></bdt>The arbitration shall
				...
				Arbitration Association (<bdt class="block-component"></bdt>"AAA"<bdt
					class="statement-end-if-in-editor"
				></bdt>) and, where appropriate, the AAA’s Supplementary Procedures for Consumer Related
				Disputes (<bdt class="block-component"></bdt>"AAA Consumer Rules"<bdt
					class="statement-end-if-in-editor"
				></bdt>), both of which are available at the
				<span style="font-size: 15px; line-height: 16.8667px; color: rgb(0, 58, 250);"
					><a
						data-custom-class="link"
						href="http://www.adr.org"
						rel="noopener noreferrer"
						target="_blank">American Arbitration Association (AAA) website</a
					></span
				...
				<bdt class="else-block"></bdt>The arbitration may be conducted in person, through the
				...
				<bdt class="block-component"></bdt>AAA<bdt class="else-block"></bdt> rules or applicable
				law, the arbitration will take place in <bdt class="block-component"></bdt><bdt
					class="question noTranslate">Suffolk County</bdt
				>, <bdt class="statement-end-if-in-editor"></bdt><bdt class="block-component"></bdt><bdt
					class="question noTranslate">Massachusetts</bdt
				><bdt class="statement-end-if-in-editor"></bdt>. Except as otherwise provided herein, the
				Parties may litigate in court to compel arbitration, stay proceedings pending arbitration,
				or to confirm, modify, vacate, or enter <bdt class="block-component"></bdt>judgment<bdt
					class="statement-end-if-in-editor"
				></bdt> on the award entered by the arbitrator.</span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;"><br /></div>
		<div
		...
		>
			<span style="font-size: 15px;"
				...
				be commenced or prosecuted in the</span
			><bdt class="block-component" style="font-size: 15px;"></bdt><span style="font-size: 15px;"
				>&nbsp;state and federal courts</span
			><bdt class="statement-end-if-in-editor" style="font-size: 15px;"></bdt><span
				style="font-size: 15px;">&nbsp;located in</span
			><bdt class="block-component" style="font-size: 15px;"></bdt>
			<bdt class="question noTranslate">Suffolk County</bdt><span style="font-size: 15px;">,</span
			><bdt class="statement-end-if-in-editor" style="font-size: 15px;"></bdt><bdt
				class="block-component"
				style="font-size: 15px;">&nbsp;</bdt
			><bdt class="question noTranslate" style="font-size: 15px;">Massachusetts</bdt><bdt
				class="statement-end-if-in-editor"
				style="font-size: 15px;"
			></bdt><span style="font-size: 15px;"
				>, and the Parties hereby consent to, and waive all <bdt class="block-component"
				></bdt>defenses<bdt class="statement-end-if-in-editor"></bdt> of lack of personal
				jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such<bdt
					class="block-component"
				></bdt>
				state and federal courts<bdt class="statement-end-if-in-editor"></bdt>. Application of the
				United Nations Convention on Contracts for the International Sale of Goods and the Uniform
				Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.</span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;"><br /></div>
		<div
		...
		>
			<span style="font-size: 15px;"
				><bdt class="block-component"></bdt>In no event shall any Dispute brought by either Party
				related in any way to the Services be commenced more than
				<bdt class="question">one (1)</bdt>
				years after the cause of action arose. <bdt class="statement-end-if-in-editor"></bdt>If this
				...
				jurisdiction of that court.<bdt class="block-component"></bdt></span
			>
		</div>
		<div
			class="MsoNormal"
		...
		>
			<strong
				><span style="font-size: 19px; line-height: 1.5;"><h2>15. CORRECTIONS</h2></span></strong
			>
		</div>
		<div
			class="MsoNormal"
		...
		>
			<span style="font-size: 19px; line-height: 1.5; color: rgb(0, 0, 0);"
				><strong><h2>16. DISCLAIMER</h2></strong></span
			>
		</div>
		<div
			class="MsoNormal"
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
		...
		>
			<strong
				><span style="line-height: 1.5; font-family: Arial; font-size: 19px;"
					><h2>17. LIMITATIONS OF LIABILITY</h2></span
				></strong
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;">
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				...
				and expenses, made by any third party due to or arising out of: <bdt
					...
					>) breach of these Legal Terms; (<span style="font-size: 14.6667px;">3</span>) any breach
					of your representations and warranties set forth in these Legal Terms; (<span
						style="font-size: 14.6667px;">4</span
					>) your violation of the rights of a third party, including but not limited to
					intellectual property rights; or (<span style="font-size: 14.6667px;">5</span>) any overt
					...
					or proceeding which is subject to this indemnification upon becoming aware of it.</bdt
				></span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;"><br /></div>
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
		...
		>
			<strong
				><span style="line-height: 1.5; font-family: Arial; font-size: 19px;"
					><h2>20. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2></span
				></strong
			>
		</div>
		<div
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
		...
		>
			<strong
				><span style="line-height: 1.5; font-family: Arial; font-size: 19px;"
					><h2>21. CALIFORNIA USERS AND RESIDENTS</h2></span
				></strong
			>
		</div>
		<div
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
				...
				95834 or by telephone at (800) 952-5210 or (916) 445-1254.</span
			>
		</div>
		<div class="MsoNormal" style="line-height: 1.5; text-align: left;">
			<bdt class="statement-end-if-in-editor"></bdt>
		...
		>
			<strong
				><span style="line-height: 115%; font-family: Arial;"
					><span style="font-size: 19px; line-height: 1.5;"><h2>23. CONTACT US</h2></span></span
				></strong
			>
		</div>
		<div
...
Calibri;color:#595959;mso-themecolor:text1;mso-themetint:166;"
		...
		>
			<span style="font-size: 15px;"
				><span style="color: rgb(89, 89, 89);"
					><bdt class="question noTranslate"><strong></strong></bdt><strong
						><bdt class="block-component"></bdt></strong
					></span
		...
		>
			<strong
				><span style="font-size: 15px;"
					><strong
						><span style="color: rgb(89, 89, 89);"
							><bdt class="question"><bdt class="block-component"></bdt></bdt><bdt
								class="block-component"
							></bdt><bdt class="block-component"></bdt>
							<bdt class="question noTranslate"></bdt><bdt class="statement-end-if-in-editor"
							></bdt><bdt class="block-component"></bdt><bdt class="block-component"></bdt></span
					...
					><strong
						><span style="color: rgb(89, 89, 89);"><bdt class="block-component"></bdt></span><bdt
							class="block-component"
						></bdt><bdt class="block-component"></bdt></strong
					></span
				></strong
			>
		</div>
		...
		>
			<strong
				><span style="font-size: 15px;"
					><bdt class="question noTranslate"><strong>United States</strong></bdt><strong
						><bdt class="statement-end-if-in-editor"
							><span style="color: rgb(89, 89, 89);"
								><strong
									><span style="font-size: 15px;"
...
<style>
	[data-custom-class="body"] {
		...
		font-family: var(--m3-font, "Roboto Flex", sans-serif);
		line-height: 1.6;
		max-width: 1200px;
		margin: 0 auto;
		padding: 2rem;
	...
	[data-custom-class="link"] {
		...
		text-decoration-color: rgb(var(--m3-scheme-outline-variant));
	...
	li span[style*="text-indent: -29.4px"],
	li span[style*="text-indent:-29.4px"] {
	...
	li[data-custom-class="body_text"] span span {
		color: rgb(var(--m3-scheme-on-surface-variant)) !important;
		background-color: transparent !important;
		text-indent: 0 !important;
		font-family: var(--m3-font, "Roboto Flex", sans-serif) !important;
	}
